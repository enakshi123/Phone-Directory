            ...
            <div>
                ...
                <div className="component-body-container">
                    ...
                    <form className="subscriber-form" onSubmit={this.onFormSubmitted.bind(this)}>
                        ...
                        <input id="phone" type="text" className="input-control" name="phone" onChange={this.inputChangedHandler} /><br />
                        <label htmlFor="email" className="label-control">Email: </label><br />
                        <input id="email" type="text" className="input-control" name="email" onChange={this.inputChangedHandler} /><br />
